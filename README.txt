...
And lastly there is the folder: modeling_data containing the predictions output of the first modeling iteration of logistic regression, random forest and XGBoost.
